<template>
    <main><!-- 
        ...
        <search></search>
        <h2 class="main-heading">Избранное</h2>
                ...
                <form class="option-delete" action="" id="delete-files" onsubmit="return false;">
                    ...
                    <div class="option-delete__dots" role="button" id="deleteDots" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu" aria-labelledby="deleteDots">
                            <a class="dropdown-item delete-return" href="#">Открыть доступ</a>
                            <a class="dropdown-item delete-delete" href="#">Копировать ссылку общего доступа</a>
                            <a class="dropdown-item delete-delete" href="#">Переименовать</a>
                            <a class="dropdown-item delete-delete" href="#">Удалить из избранных</a>
                            <a class="dropdown-item delete-delete" href="#">Создать копию</a>
                            <a class="dropdown-item delete-delete" href="#">Переименовать</a>
                            <a class="dropdown-item delete-delete" href="#">Скачать</a>
...
<script>
    ...
    import RemoveFromFavorites from "../layouts/blocks/modals/basket/RemoveFromFavorites";

    RemoveFromFavorites
    export default {
        name: "Index",
        components: {RestoreObject, RemoveObject, RemoveFromFavorites}
    }
</script>
